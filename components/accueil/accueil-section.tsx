  ...
  return (
    <div className="flex flex-row h-full w-full items-center justify-center">
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        >
          Je construis des applications complètes et responsives, mobiles ou web. Rien ne m&apos;arrête,
          je suis un entrepreneur dans l&apos;âme et autodidacte depuis toujours.
        </motion.p>
        ...
        >
          ...
          <div className="flex flex-row gap-2">
            ...
            >
              <Image src={Prisma} alt="image" height={25} width={25} className="block dark:hidden" />
              <Image src={PrismaLight} alt="image" height={25} width={25} className="hidden dark:block" />
            </motion.div>
            <motion.div
              initial={{ y: 0 }}
              animate={{ y: [-10, 10, 0] }}
            ...
            <p className="font-bold flex items-center justify-center text-black dark:text-white">... et plus encore</p>
          </div>
        </motion.div>
      ...
      >
        <Image src={Me} alt="avatar" className="h-56 object-cover rounded-full w-96 border-8 border-primary p-2 dark:border-primary max-xl:hidden" />
      </motion.div>
    </div>
  )
}
